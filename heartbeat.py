...
msg = (
    f"💓 <b>Heartbeat DRAGON BALL Fusion World</b> 🐉\n"
    f"📅 {datetime.utcnow().strftime('%Y-%m-%d %H:%M UTC')}\n\n"
    f"✅ Bot vivo y funcionando\n"
    f"🏪 Tiendas configuradas: {n_sites_cfg}\n"
    f"📊 Tiendas con producto DB: {n_sites_tracked}\n"
    f"📦 Productos Dragon Ball tracked: {total_products}\n"
    f"  • En stock: {in_stock}\n"
    f"  • Agotados: {oos}\n\n"
    f"🔥 Foco: MANGA BOOSTER (sets SB) + cases + promos.\n"
